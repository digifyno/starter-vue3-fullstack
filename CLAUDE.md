...
| POST | `/api/ai/chat` | Cookie/Bearer | Chat: `{message, history?}`; `message` max 4000 chars, `history` max 50 items; rate-limited (20 req/min per IP); 503 if AI Hub not configured |
