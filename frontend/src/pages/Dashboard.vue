  ...
  <div class="space-y-6">
    ...
    <div class="grid gap-6 md:grid-cols-2">
      ...
      <div class="rounded-lg border border-border bg-card p-6">
        ...
        <!-- Loading skeleton -->
        <div v-if="hubLoading" class="animate-pulse space-y-3" role="status" aria-label="Loading hub status">
        ...
        <div v-else-if="hubError" role="alert" class="space-y-3">
          <p class="text-sm text-red-600 dark:text-red-400">
            Could not connect to AI Hub. Some features may be unavailable.
          </p>
          <button
            @click="retryHubStatus"
